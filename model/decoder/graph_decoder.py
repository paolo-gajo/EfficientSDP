...
class GraphDecoder(nn.Module):
    ...
    def _greedy_decode(
        ...
        # save_heatmap(arc_logits[0], filename='arc_logits_diag.pdf')
        arc_logits = arc_logits + diag_mask
        # save_heatmap(arc_logits[0], filename='arc_logits_nodiag.pdf')
        # save_heatmap(arc_logits[0], filename='arc_logits_2.pdf')
        ...
        # save_heatmap(arc_logits[0], filename='arc_logits_3.pdf')
